...
export const PwaInstallBanner: React.FC = () => {
  ...
  return (
    <>
      {/* 1. Install App Banner (If not yet installed and install prompt is available) */}
      {!isStandalone && deferredPrompt && (
        <div className="bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-800 text-white px-4 py-3 shadow-lg flex items-center justify-between gap-3 text-xs sm:text-sm font-medium animate-fadeIn border-b border-blue-600/30">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0">
              <p className="font-bold text-white text-sm">Install App for Background Alerts</p>
              <p className="text-xs text-blue-100/90 truncate">Receive instant shift reminders even when app is closed</p>
            </div>
          </div>
      ...
      {/* 2. Battery Optimization Helper Button for Installed PWAs */}
        ...
        <div className="bg-slate-900 text-slate-100 px-4 py-2.5 shadow-sm flex items-center justify-between gap-3 text-xs sm:text-sm border-b border-slate-800">
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <p className="truncate text-slate-300 text-xs sm:text-sm">
              <span className="font-semibold text-white">Ensure Reliable Closed-App Alerts:</span> Set battery optimization to Unrestricted.
            </p>
          </div>
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-700">
              <div className="p-3.5 bg-blue-50/70 rounded-xl border border-blue-100 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700 mt-0.5">Long-press the <strong>Smart Staff</strong> app icon on your home screen and tap <strong>App Info ( ⓘ )</strong>.</p>
                </div>
              </div>
              ...
              <div className="p-3.5 bg-amber-50/70 rounded-xl border border-amber-100 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700 mt-0.5">Tap <strong>Battery</strong> and select <strong>Unrestricted</strong> (or Allow Background Activity).</p>
                </div>
              </div>
            </div>
