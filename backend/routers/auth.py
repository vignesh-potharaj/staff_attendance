...
def build_login_response(user: User) -> dict:
    ...
    return {
        ...
        "user": {
            ...
            "pay_type": getattr(user_record, "pay_type", "hourly"),
            "default_shift_start": getattr(user_record, "default_shift_start", "09:00:00") or "09:00:00",
            "default_shift_end": getattr(user_record, "default_shift_end", "18:00:00") or "18:00:00",
            "tenant_id": user_record.tenant_id,
